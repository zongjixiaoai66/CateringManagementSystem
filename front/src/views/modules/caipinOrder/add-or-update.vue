    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预定数量" prop="buyNumber">
                       <el-input v-model="ruleForm.buyNumber"
                                 placeholder="预定数量" clearable  :readonly="ro.buyNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="预定数量" prop="buyNumber">
                           <el-input v-model="ruleForm.buyNumber"
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="预定时间" prop="caipinOrderTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.caipinOrderTime" label="预定时间" prop="caipinOrderTime">
